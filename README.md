...
MS SQL Server (LocalDB, Express, or Developer edition).
...
bash
dotnet build
Run the Presentation Layer web project:

bash
dotnet run --project PharmacyManagement.PL
Access the application: Open your browser and navigate to the local host URL shown in your terminal (typically https://localhost:7001 or http://localhost:5000).
